...
export default function Chat() {
    ...
    return ( <
        div className = "flex h-screen bg-gradient-to-br from-purple-950 via-purple-900 to-purple-950 text-white" > { /* Sidebar */ } <
        div className = { `fixed top-0 left-0 h-full bg-purple-900/50 backdrop-blur-md border-r border-purple-700/30 transition-transform duration-300 z-50 ${
